...
export function ProductPriceEditDialog({ item, onUpdated }: { item: any, onUpdated?: () => void }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Atualize o preço para a tabela selecionada.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
