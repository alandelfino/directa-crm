    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="sm:max-w-[600px] flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 px-6 overflow-y-auto">
          <Tabs defaultValue="movement" className="h-full flex flex-col">
            <div className="px-1 pt-2">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="movement">Movimentação</TabsTrigger>
                <TabsTrigger value="observation">Observações</TabsTrigger>
              </TabsList>
            </div>

            <TabsContent value="movement" className="flex-1 mt-0">
            ...
            <TabsContent value="observation" className="flex-1 mt-0 py-4">
