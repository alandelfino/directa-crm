...
const DashboardStockIndexRoute = DashboardStockIndexRouteImport.update({
  id: '/stock/',
  path: '/stock/',
  getParentRoute: () => DashboardRouteRoute,
} as any)
...
const DashboardSettingsPriceTablesIndexRoute =
  DashboardSettingsPriceTablesIndexRouteImport.update({
    id: '/price-tables/',
    path: '/price-tables/',
    getParentRoute: () => DashboardSettingsRouteRoute,
  } as any)
...
const DashboardSettingsMediaSizesIndexRoute =
  DashboardSettingsMediaSizesIndexRouteImport.update({
    id: '/media-sizes/',
    path: '/media-sizes/',
    getParentRoute: () => DashboardSettingsRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dashboard/stock/': {
      ...
      preLoaderRoute: typeof DashboardStockIndexRouteImport
      parentRoute: typeof DashboardRouteRoute
    }
    '/dashboard/settings/': {
      id: '/dashboard/settings/'
    ...
    '/dashboard/settings/price-tables/': {
      id: '/dashboard/settings/price-tables/'
      path: '/price-tables'
      fullPath: '/dashboard/settings/price-tables'
    ...
    '/dashboard/settings/menus/': {
      ...
      path: '/menus'
      fullPath: '/dashboard/settings/menus'
      preLoaderRoute: typeof DashboardSettingsMenusIndexRouteImport
      parentRoute: typeof DashboardSettingsRouteRoute
    }
    '/dashboard/settings/media-sizes/': {
      id: '/dashboard/settings/media-sizes/'
      path: '/media-sizes'
      fullPath: '/dashboard/settings/media-sizes'
