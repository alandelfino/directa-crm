    ...
    <div className='flex flex-col w-full h-full p-6 space-y-6'>
      <div className='flex items-center justify-between'>
        <div className='flex flex-col space-y-1'>
          <h2 className='text-2xl font-bold tracking-tight text-foreground'>Tamanhos de Mídia</h2>
          <p className='text-sm text-muted-foreground'>Configure os tamanhos permitidos para imagens e mídias.</p>
        </div>
        <div className='flex items-center gap-2'>
