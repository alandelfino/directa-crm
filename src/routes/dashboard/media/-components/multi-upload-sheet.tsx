          ...
          <div className='flex flex-col h-full'>
            ...
            <div className='px-4 mt-6 space-y-4'>
              <div className='grid gap-2'>
                <Label>Destino</Label>
                <Select value={uploadTo} onValueChange={(v) => setUploadTo(v as any)} disabled={isUploading}>
            ...
            <div className='flex-1 min-h-0 overflow-auto px-4 mt-2'>
                    ...
                    <div className='flex items-center justify-between gap-3'>
                      <div className='flex items-center gap-3 min-w-0 flex-1'>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          <div className='text-xs text-muted-foreground'>{(item.file.size / 1024).toFixed(2)} KB • {item.to}</div>
